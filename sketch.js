...
soldier = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 soldier.addImage(soldierImg)
  ...
  invisiblewall1 = createSprite(1320,400,20,1000);
  invisiblewall1.visible = false;

  invisiblewall2 = createSprite(10,400,20,1000);
...
soldier.collide(invisiblewall1);
soldier.collide(invisiblewall2);
...
function enemy(){
  ...
  bomb = createSprite(2000,450,50,50)
...
function enemy1(){
 if(frameCount%60===0){
    bomb1 = createSprite(2000,450,50,50);
...
function food () {
  if(frameCount%70===0){
    medikit = createSprite(2000,450,50,50);
